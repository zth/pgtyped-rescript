/* TypeScript file generated from BookServiceParams2__sql.res by genType. */
...
export const Query1_many: (_1:PgTyped_Pg_Client_t, _2:query1Params) => Promise<query1Result[]> = BookServiceParams2__sqlJS.Query1.many as any;

/** Returns exactly 1 result. Returns `None` if more or less than exactly 1 result is returned. */
export const Query1_one: (_1:PgTyped_Pg_Client_t, _2:query1Params) => Promise<(undefined | query1Result)> = BookServiceParams2__sqlJS.Query1.one as any;

/** Returns exactly 1 result. Raises `Exn.t` (with an optionally provided `errorMessage`) if more or less than exactly 1 result is returned. */
export const Query1_expectOne: (_1:PgTyped_Pg_Client_t, _2:query1Params, errorMessage:(undefined | string)) => Promise<query1Result> = BookServiceParams2__sqlJS.Query1.expectOne as any;
...
} = BookServiceParams2__sqlJS.Query1 as any;
