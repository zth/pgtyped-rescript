...
module FindBookByCategory: {
  ...
  let expectOne: (
    ...
    ~errorMessage: string=?
  ) => promise<findBookByCategoryResult>
...
module FindBookNameOrRank: {
  ...
  let expectOne: (
    ...
    ~errorMessage: string=?
  ) => promise<findBookNameOrRankResult>
...
module UpdateBooksCustom: {
  ...
  let expectOne: (
    ...
    ~errorMessage: string=?
  ) => promise<updateBooksCustomResult>
...
module UpdateBooksRankNotNull: {
  ...
  let expectOne: (
    ...
    ~errorMessage: string=?
  ) => promise<updateBooksRankNotNullResult>
...
module GetBooksByAuthorName: {
  ...
  let expectOne: (
    ...
    ~errorMessage: string=?
  ) => promise<getBooksByAuthorNameResult>
...
module AggregateEmailsAndTest: {
  ...
  let expectOne: (
    ...
    ~errorMessage: string=?
  ) => promise<aggregateEmailsAndTestResult>
...
module GetBookCountries: {
  ...
  let expectOne: (
    ...
    ~errorMessage: string=?
  ) => promise<getBookCountriesResult>
